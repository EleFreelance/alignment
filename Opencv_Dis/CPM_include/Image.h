...
public:
	...
	virtual bool imresize(float ratio, InterType type = INTER_LINEAR_IMAGE);
	template <class T1>
	void imresize(Image<T1>& result, float ratio, InterType type = INTER_LINEAR_IMAGE) const;
	void imresize(int dstWidth, int dstHeight, InterType type = INTER_LINEAR_IMAGE);
	template <class T1>
	void imresize(Image<T1>& result, int dstWidth, int dstHeight, InterType type = INTER_LINEAR_IMAGE) const;
